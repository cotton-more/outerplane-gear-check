...
export const en: Texts = {
  ...
  ui: {
    ...
    verdict: 'Verdict',
    tierLegend: 'The number by a stat is its tier in the build priority (1 = most important); yellow — counts as ½; crossed out — not needed by the build.',
    ...
    anyMain: 'any',
    tierTitle: (tier, half) => `tier ${tier}${half ? ' — counts as ½' : ''}`,
    notNeeded: 'not needed by the build',
    toEval: '← Evaluate',
    ...
    steps: [
      ...
      '**The verdict** appears right away, with an explanation. "Reset" — on to the next item.',
    ],
