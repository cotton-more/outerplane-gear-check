...
export const ru = {
  ...
  ui: {
    ...
    verdict: 'Вердикт',
    tierLegend: 'Цепочка — приоритет сабстатов билда, слева важнее. Зелёный — есть на предмете и засчитан, жёлтый — за ½, серый — есть, но далеко в цепочке (мелкие места с 5-го не считаются), пунктир — нет на предмете, с пометкой main — это main stat предмета (сабстатом не бывает, растёт от Enhance), зачёркнут — билду не нужен.',
