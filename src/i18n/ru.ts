...
export const ru = {
  ...
  ui: {
    ...
    helpInputItems: [
      ...
      '**4-й сабстат у Epic** — Epic выпадает с тремя, четвёртый добавляет первый Reforge. Сделал Reforge — отметь его кнопкой «+ 4-й сабстат от Reforge»: он может вытянуть вещь. Какой именно вытянет, подскажет «Прокачка».',
      'Нажми на стат в строке, чтобы заменить его (жёлтые сегменты останутся). Убрать — ещё раз нажать его в сетке или ✕. Код, справка и настройки — в меню ☰.',
    ],
